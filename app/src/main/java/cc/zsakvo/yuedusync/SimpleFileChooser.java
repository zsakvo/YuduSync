...
public class SimpleFileChooser extends DialogFragment implements android.content.DialogInterface.OnClickListener {
    private SimpleFileChooser.SimpleFileChooserListener simpleFileChooserListener;
    ...
    public void setOnChosenListener(cc.zsakvo.yuedusync.SimpleFileChooser.SimpleFileChooserListener sfc) {
